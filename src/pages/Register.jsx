...
function Register() {
  ...
  return (
    <div className="flex flex-col gap-0 text-gray-200 min-h-screen relative">
      <NavBar />
      ...
      <div className="flex flex-col items-center text-start gap-5 relative justify-center align-middle scale-90">
        <h1 className="text-5xl text-nowrap md:text-6xl">
          Registrate<span className="text-[#00c8ff] font-semibold">.</span>
        </h1>
        <form className="grid grid-cols-2 w-full md:w-[500px] gap-2 box-border">
          ...
          <div className="bg-[#1a1a1a] border-[#121212] border-2 rounded-xl p-2 outline-none focus-within:border-[#00c8ff] col-span-2 shadow-xl">
            <span className="text-[#00c8ff] text-[12px] font-semibold text-center">Usuario *</span>
            <input
          ...
          <div className="grid grid-cols-3 gap-2 grid-rows-[15px] place-items-center place-content-center col-span-2 bg-[#1a1a1a] border-[#121212] border-2 rounded-xl p-2 shadow-xl">
            <span className="text-[#00c8ff] text-[12px] font-semibold text-start col-span-3 place-self-start">
              Fecha de nacimiento *
            </span>

            <div className="flex flex-row bg-[#0a0a0a] border-[#121212] border-2 p-2 box-border gap-2 w-full justify-center align-middle rounded">
              <span>Dia</span>
              <input
                className="bg-transparent outline-none focus:outline-[#00c8ff] w-5 text-gray-200"
                type="email"
                placeholder="00"
              />
            </div>
            ...
            <div className="flex flex-row bg-[#0a0a0a] border-[#121212] border-2 p-2 box-border gap-2 w-full justify-center align-middle rounded">
              <span>Anho</span>
              <input
                className="bg-transparent outline-none focus:outline-[#00c8ff] w-10 text-gray-200"
                type="email"
                placeholder="00"
              />
            </div>
          ...
          <button
            className="bg-[#0a0a0a] border-[#121212] border-2 rounded-xl p-2 col-span-2 transition-all duration-200 transform hover:bg-[#121212] hover:border-[#00c8ff] shadow-xl cursor-pointer"
            type="submit"
          >
            Registrarse
          </button>
        ...
        <h1 className="text-[10px] -mt-3">
          ...
          <a className="text-[#00c8ff] underline" href="/">
        ...
        <h1 className="-mt-3">
          ...
          <a className="font-semibold underline text-[#00c8ff]" href="/login">
            Inicia sesion
          </a>
        </h1>
      </div>
