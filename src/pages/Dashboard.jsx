  ...
  return (
    <div className="min-h-screen h-screen grid grid-cols-[70px_2fr_8fr_3fr] xl:grid-cols-[70px_2fr_8fr_2fr] 2xl:grid-cols-[70px_2fr_8fr_1fr] grid-rows-[35px_8fr_2fr_1fr] 2xl:grid-rows-[35px_8fr_2fr_0.5fr]">
      ...
      <div className="bg-[#121212] row-start-1 row-end-4" id="friends">
        ...
        <div className="flex flex-row gap-2 items-center pl-2 pr-2 text-gray-300 m-2 justify-between">
  ...
  [&::-webkit-scrollbar-thumb]:bg-[#00c8ff]"
      ...
      >
        <div className="flex flex-row gap-2 items-center cursor-pointer">
          <FaHashtag className="text-[20px] text-[#00c8ff]"></FaHashtag>
          <span>general</span>
        </div>
      ...
      <div
        className="bg-[#0a0a0a] row-start-4 row-end-4 flex flex-col justify-center"
        id="user-profile"
      >
        <div className="flex flex-row gap-2 items-center pl-2 pr-2 text-gray-300 m-2 justify-between">
          <MembersInner pfp={keven} author="! IrregularDev" />
